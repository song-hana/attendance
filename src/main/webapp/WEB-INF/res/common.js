...
function input_company_header() {
    ...
    header_txt += '             <button type="button" class="btn gnb_btn"><i class="fa-solid fa-bars"></i></button>'
    header_txt += '             <ul class="gnb collapse">'
    header_txt += '                 <li><a href="/company/notice/ntclist">공지사항</a></li>'
    header_txt += '                 <li><a href="/company/ask/asklist">문의사항</a></li>'
    header_txt += '             </ul>'
    header_txt += '          </div>'
    header_txt += '          <div class="col logo">'
...
function input_admin_header() {
    ...
    header_txt += '          </div>'
    header_txt += '          <div class="col btns mt-1 text-end">'
    header_txt += '             <a href="/admin/logout" class="collapse show">로그아웃</a>'
    header_txt += '          </div>'
    header_txt += '     </div>'
    header_txt += ' </div>'
